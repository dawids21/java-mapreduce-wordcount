...
docker tag mapreduce/javamapreduce:latest public.ecr.aws/v4e3t3o3/mapreduce/javamapreduce:latest
docker tag mapreduce/javamapreduce-cli:latest public.ecr.aws/v4e3t3o3/mapreduce/javamapreduce-cli:latest
docker push public.ecr.aws/v4e3t3o3/mapreduce/javamapreduce:latest
